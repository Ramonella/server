/* Generated By:JJTree&JavaCC: Do not edit this line. Analizador_Tuplas.java */
package XML.Tuplas_Tabla;
import java.io.*;

public class Analizador_Tuplas/*@bgen(jjtree)*/implements Analizador_TuplasTreeConstants, Analizador_TuplasConstants {/*@bgen(jjtree)*/
  protected JJTAnalizador_TuplasState jjtree = new JJTAnalizador_TuplasState();
  ...
  final public void fila() throws ParseException {
             /*@bgen(jjtree) fila */
  SimpleNode jjtn000 = new SimpleNode(JJTFILA);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
      jj_consume_token(abre_etiqueta);
  ...
  public Analizador_TuplasTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x80,0x2a00000,0x1000000,0x1000000,};
   }
  ...
  public Analizador_Tuplas(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public Analizador_Tuplas(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new Analizador_TuplasTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public Analizador_Tuplas(java.io.Reader stream) {
  ...
  public Analizador_Tuplas(Analizador_TuplasTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(Analizador_TuplasTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jjtree.reset();
