/* Generated By:JJTree&JavaCC: Do not edit this line. Analizador_Object.java */
package XML.Object;
import java.io.*;

public class Analizador_Object/*@bgen(jjtree)*/implements Analizador_ObjectTreeConstants, Analizador_ObjectConstants {/*@bgen(jjtree)*/
  protected JJTAnalizador_ObjectState jjtree = new JJTAnalizador_ObjectState();
  ...
  public Analizador_ObjectTokenManager token_source;
  ...
  public Analizador_Object(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public Analizador_Object(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new Analizador_ObjectTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public Analizador_Object(java.io.Reader stream) {
  ...
  public Analizador_Object(Analizador_ObjectTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(Analizador_ObjectTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jjtree.reset();
